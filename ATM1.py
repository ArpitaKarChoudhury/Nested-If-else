...
if card == "yes" or card == "YES" :
	...
	if language== "english" or language == "ENGLISH":
		...
		if pin>999 and pin<10000:
			...
			t_type=int(input("Choose tansactions: "))
			if t_type== 1 :
				ac_type=input("enter account type ")
				if ac_type=="saving" or ac_type == "SAVING" or ac_type == "CURRENT" or ac_type=="current":
				...
				if ac_type=="saving" or ac_type == "SAVING" or ac_type=="current" or ac_type == "CURRENT":
					...
					if bal_enquiry=="yes" or bal_enquiry=="YES":
						print("total amount :")
						print("enquiry done")
				...
				if account_num>=1000000000 and account_num<=99999999999:
				...
				if account_num>=1000000000 and account_num<=99999999999:
					...
					if bill_p>=100 and bill_p<=20000:
						print("your bill pay successful",bill_p)
						k_n=input("enter key name: ")
						if k_n=="enter" or k_n=="Enter" or k_n == "ENTER":
							print(" thank you: ")
						else:
							print("invalid key")
					else:
						print("your bill pay unsuccessful: ")
				else:
